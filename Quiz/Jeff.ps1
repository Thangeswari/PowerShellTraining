...
$message = $message +"`r`n"+"You speak from heart and care for otxers! Otxers need you!".Replace('x','h')
...
$message = $message +"`r`n"+[char[]][int[]](69,116,101,114,110,97,108,32,83,116,114,101,110,103,116,104)
